...
# =====================================================================
RAW_DIR_11 = '/lustre/MSSP/sittipong/all/data/2024_05_11'
RAW_DIR_12 = '/lustre/MSSP/sittipong/all/data/2024_05_12'    ####

BASE_SAVE_DIR = '/lustre/MSSP/sittipong/reduce2/2024-05-11'  
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
    {
        ...
        'data': {
            'runs': [
                ['run013', 1, 15], # Note: Focus changed during this run
                ['run017', 1, 15], 
                ['run021', 1, 15]
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
    ...
    #         'runs': [
                # ['run014', 1, 15],
                # ['run018', 1, 15], 
                # ['run022', 1, 9]   # Note: Marked as cloudy
    #         ], 
    #         'ccd': '1', 
    #         'rawdir': RAW_DIR_12
    #     }
