...
# =====================================================================
RAW_DIR_08 = '/lustre/MSSP/sittipong/all/data/2023_11_08'
RAW_DIR_07 = '/lustre/MSSP/sittipong/all/data/2023_11_07' # For missing flats

BASE_SAVE_DIR = '/lustre/MSSP/sittipong/reduce2/2023-11-08'
...
INPUT_RUNS = [
    {
        'run_name': '2023_11_08_g',
        'bias_data': {'runs': [['run002', 2, 0]], 'rawdir': RAW_DIR_08, 'ccd': '1'},
        'bias_dark': None, 
        ...
        'data': {
            'runs': [
                ...
                ['run024', 1, 20], 
                ['run028', 1, 20],
                ['run034', 1, 15], # Note: marked as "with clear"
                ['run035', 1, 20], 
                ['run039', 1, 20]
            ], 
            'ccd': '1', 
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
    {
        ...
        'data': {
            'runs': [
                ['run008', 1, 30], 
                ['run009', 1, 30], # Note: marked as "adjust focus"
                ['run013', 1, 20],
                ['run017', 1, 20], 
                ['run021', 1, 20], 
                ['run025', 1, 20],
